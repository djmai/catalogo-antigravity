          ...
          <Table className="w-full min-w-[800px]">
            <TableHeader className="bg-slate-50/50">
              <TableRow className="hover:bg-transparent border-slate-100">
                <TableHead className="py-6 px-6 font-black text-[#2B364A] uppercase tracking-widest text-[10px]">Producto</TableHead>
                <TableHead className="py-6 px-4 font-black text-[#2B364A] uppercase tracking-widest text-[10px]">Usuario</TableHead>
                <TableHead className="py-6 px-4 font-black text-[#2B364A] uppercase tracking-widest text-[10px]">Calificación</TableHead>
                <TableHead className="py-6 px-4 font-black text-[#2B364A] uppercase tracking-widest text-[10px]">Comentario</TableHead>
                <TableHead className="py-6 px-4 font-black text-[#2B364A] uppercase tracking-widest text-[10px]">Estado</TableHead>
                <TableHead className="py-6 px-6 font-black text-[#2B364A] uppercase tracking-widest text-[10px] text-right">Acciones</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={6} className="h-64 text-center border-none">
                     ...
                     <p className="text-slate-400 font-bold uppercase text-[10px] tracking-widest text-center">No hay reseñas registradas aún</p>
                  </TableCell>
                </TableRow>
              ) : reviews.map((r) => (
                <TableRow key={r.id} className="hover:bg-slate-50/80 border-slate-100 transition-colors group">
                  <TableCell className="py-6 px-6">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-bold text-[#2B364A] text-sm whitespace-nowrap">{r.products?.name}</span>
                    </div>
                  </TableCell>
                  <TableCell className="py-6 px-4">
                    <span className="text-xs font-medium text-slate-500 whitespace-nowrap">{r.user_email}</span>
                  </TableCell>
                  <TableCell className="py-6 px-4">
                  ...
                  <TableCell className="py-6 px-6 text-right">
                    ...
                    {r.status === 'pending' && (
                      <Button 
                        ...
                        className="h-8 w-8 p-0 rounded-lg hover:bg-[#6CF3D5]/20 text-[#21A3A3]"
                      >
                    ...
                    {r.status === 'pending' && (
                      <Button 
                        ...
                        className="h-8 w-8 p-0 rounded-lg hover:bg-rose-50 text-rose-500"
                      >
                    ...
                    <Button 
                      ...
                      className="h-8 w-8 p-0 rounded-lg hover:bg-slate-100 text-slate-400 hover:text-slate-900"
                    >
